...
Al pulsar para crear el PullRequest nos aparecerá una nueva ventana en la que, si todo va bien, podremos observar la ejecución del workflow mostrandonos al final el estado de ejecución del workflow  
